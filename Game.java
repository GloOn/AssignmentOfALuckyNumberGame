...
public class Game
{
     ...
     */
    private boolean compare(int a, int b, boolean isFinal)
    {
        boolean isWin = false;
        if (a == b)
        {
            System.out.println("Luck Number was : " + b + ", your final guess was : " + a);
            System.out.println("Congratulations : you WON $10...\n");
            //the player guess the right number
            //so winOneRound method will change the wins statistics.
            player.winOneRound(10);
            isWin = true;
        }
        else
        {
            if (isFinal)//check if this time is the final guess.
            {
                System.out.println("Luck Number was : " + b + ", your final guess was : " + a);
                if (b - a <= 5 && a - b <= 5)
                {
                    System.out.println("Congratulations : you WON $5...\n");
                    //the player guess the ±5 of the lucky number, 
                    //so withinFive method will change the wins statistics.
                    player.winOneRound(5);
                }
                else
                {
                    System.out.println("Sorry, better luck next time!\n");
                    //the player guess the wrong number, 
                    //so lossOneRound method will change the wins statistics.
                    player.lossOneRound();
                }
            }
            else
    ...
    public void startGame()
    {
        ...
        {    
            ...
            String inputChoice = ch.nextLine();
            switch (inputChoice)
            {
